...
project = 'Modelica by Example'
copyright = '2013, Michael M. Tiller'
...
htmlhelp_basename = 'ModelicaByExampledoc'
...
latex_documents = [
  ('index', 'ModelicaByExample.tex', 'Modelica by Example',
   'Michael M. Tiller', 'manual'),
]
...
man_pages = [
    ('index', 'modelicabyexample', 'Modelica by Example',
     ['Michael M. Tiller'], 1)
]
...
texinfo_documents = [
  ('index', 'ModelicaByExample', 'Modelica by Example',
   'Michael M. Tiller', 'ModelicaByExample', 'One line description of project.',
   'Miscellaneous'),
]
...
epub_title = 'Modelica by Example'
epub_author = 'Michael M. Tiller'
epub_publisher = 'Michael M. Tiller'
epub_copyright = '2013-2014, Michael M. Tiller'
