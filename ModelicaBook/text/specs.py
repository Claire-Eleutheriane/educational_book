...
rfl_vars = [Var("T["+str(x)+_("]")) for x in range(1,11)]
...
# Pendulum
add_case([_("Pendula"), _("System")], stopTime=16, res="Harm", tol=1e-6)
add_simple_plot(plot="Harm",
               vars=[Var("pendulum[1].revolute.phi"),
                     Var("pendulum[8].revolute.phi"),
                     Var("pendulum[15].revolute.phi")],
